--// Sweb UI Library with Loading Screen & Modern Visuals
...
-- Dragging Function
function Sweb:DraggingEnabled(frame, parent)
...
function Sweb.CreateLib(kavName, themeList)
    kavName = kavName or "Sweb UI"
    ...
    Logo.Image = [[data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAABVYAAAMACAYAAADPPjzCAAAAAXNSR0IB2cksfwAAAAlwSFlzAAALEwAACxMBAJqcGAAEIaFJREFUeJzs3Qd4VFX+//GbRkihhSSQkJDQQiAUFVCxsFFUFEUUhV0LYgPsin39uS6Idd1VV1dU1t21YEWwF3]]
    ...
    BarBackground.Size = UDim2.new(0, 250, 0, 8)
    ...
    BarFill.BackgroundColor3 = Color3.fromRGB(86, 76, 251)
    BarFill.Size = UDim2.new(0, 0, 1, 0)
    BarFill.BorderSizePixel = 0
    Instance.new("UICorner", BarFill).CornerRadius = UDim.new(0, 4)

    Utility:TweenObject(BarFill, {Size = UDim2.new(1, 0, 1, 0)}, 0.9, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
    wait(1)
    Utility:TweenObject(LoadingFrame, {BackgroundTransparency = 1}, 0.4)
    Utility:TweenObject(Logo, {ImageTransparency = 1}, 0.3)
    Utility:TweenObject(BarFill, {BackgroundTransparency = 1}, 0.3)
    wait(0.4)
    ...
    Close.Position = UDim2.new(0.97, 0, 0.5, 0)
    Close.Size = UDim2.new(0, 24, 0, 24)
    Close.BackgroundTransparency = 1
    Close.Image = "rbxassetid://7072725342" -- modern X icon

    Sweb:DraggingEnabled(Header, Main)

    Close.MouseButton1Click:Connect(function()
        Utility:TweenObject(Main, {Size = UDim2.new(0, 0, 0, 0)}, 0.25, Enum.EasingStyle.Back, Enum.EasingDirection.In)
        wait(0.25)
        ScreenGui:Destroy()
    end)
...
return Sweb
    ...
    logo.BackgroundTransparency = 1
    logo.Position = UDim2.new(0.87, 0, 0.1, 0)
    ...
    function Sweb:ChangeColor(prope,color)
